...
(12565, '', '', '', 'Tebogo', 'Password1', '0727215514', '', 'customer'),
(12566, '', '', '', 'Tebogo', 'Password1', '0727215514', '', 'customer'),
(12567, 'Tebogo', 'Langa', 'tebogolanga14@gmail.com', 'Tebogo', '1234', '0727215514', '', 'customer');
...
CREATE TABLE `customerservice` (
  ...
  `custService_size` double(10,1) NOT NULL,
...
INSERT INTO `customerservice` (`custService_id`, `custService_date`, `custService_size`, `custService_amount`, `cust_id`, `service_id`, `invoice_no`, `team_id`, `Location_Id`) VALUES
(77, '2021-05-28', 280.0, 16797.20, 12545, 1, 23355, 0, 114);
...
(23340, '2021-05-27', 12545, NULL),
(23341, '2021-05-27', 12545, NULL),
(23342, '2021-05-27', 12545, NULL),
(23343, '2021-05-27', 12545, NULL),
(23344, '2021-05-27', 12545, NULL),
(23345, '2021-05-27', 12545, NULL),
(23346, '2021-05-27', 12545, NULL),
(23347, '2021-05-27', 12545, NULL),
(23348, '2021-05-27', 12545, NULL),
(23349, '2021-05-27', 12545, NULL),
(23350, '2021-05-27', 12545, NULL),
(23351, '2021-05-27', 12545, NULL),
(23352, '2021-05-27', 12545, NULL),
(23353, '2021-05-27', 12545, NULL),
(23354, '2021-05-27', 12545, NULL),
(23355, '2021-05-27', 12545, NULL),
(23356, '2021-05-27', 12545, 31);
...
(113, 12545, '164 Poinsettia Crescent ebony park', '1685', 'Midrand', 'Midrand', 5),
(114, 12545, '164 Poinsettia Crescent ebony park', '1685', 'Midrand', 'Midrand', 5),
(115, 12545, '164 Poinsettia Crescent ebony park', '1685', 'Midrand', 'Midrand', 5);
...
(27, '2021-04-11', 'Paid', 12545),
(28, '2021-04-12', 'Paid', 12545),
(29, '2021-05-28', 'Paid', 12545),
(30, '2021-05-28', 'Paid', 12545),
(31, '2021-05-28', 'Paid', 12545);
...
INSERT INTO `service` (`service_id`, `service_type`, `service_price`, `service_notification`) VALUES
(1, 'Home Cleaning', 59.99, 'Y'),
(2, 'Garden cleaning', 69.99, 'Y'),
(3, 'Carpet Cleaning', 65.99, 'Y'),
(4, 'Commercial Cleaning', 49.99, 'Y');
...
ALTER TABLE `customerservice`
  ...
  ADD KEY `cust_id` (`cust_id`,`service_id`,`invoice_no`,`team_id`),
...
--
ALTER TABLE `customer`
  MODIFY `cust_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12577;

--
-- AUTO_INCREMENT for table `customerservice`
--
ALTER TABLE `customerservice`
  MODIFY `custService_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `invoice`
  MODIFY `invoice_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23357;

--
-- AUTO_INCREMENT for table `location`
--
ALTER TABLE `location`
  MODIFY `locationID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
...
ALTER TABLE `customerservice`
  ...
  ADD CONSTRAINT `customerservice_ibfk_4` FOREIGN KEY (`Location_Id`) REFERENCES `location` (`locationID`) ON DELETE CASCADE ON UPDATE CASCADE;
